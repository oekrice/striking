...
def run():
    ...
    st.markdown('''
        Use this page to upload (or record) a recording of bellringing, 'learn' the frequencies of the bells and determine the strike times. This data can be saved to the device for later or used directly on:
                ''')
